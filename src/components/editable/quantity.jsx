...
function Quantity() {
  ...
  const [modalText, setModalText] = useState(
    "Successfully Updated Bot's Api Data fetching Frequency"
  );
  const handleOk = () => {
      ...
      <div className="grid-cols-2 flex w-full">
        <div className="col-span-1 h-full w-full">
          <p className="text-red-600 text-[2rem] text-center mt-[4rem]">
            Update number of results users can see for Iphone prices.
            <br />
            <div className="flex gap-[3rem] justify-center py-[6rem]">
              <Input
                type="Number"
                max="15"
                min="0"
